...
<head>
    ...
    <title>add competition Form</title>
    <style>
    @keyframes fall {
        0% {
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="post">
                ...
                <div class="input-container">
                    <select id="competition name" name="competitionCategory" required placeholder=" ">
                        <option value="individuals">individual competition</option>
                        <option value="teams">team competition</option>
                    </select>
                    <label for="competition role">competition category</label>
                </div>
